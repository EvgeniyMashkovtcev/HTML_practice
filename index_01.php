...
<?php
$name = 'Евгений'; // строка
$city = 'Чайковский, Россия'; // строка
$profi = 'Разработчик'; // строка
$email = 'email123@email.com'; // строка
$phone = 88005553535; // десятичное число
$age = 2023-1998;
$days = (2023-1998)*365;
...
$work_experience = [
		'post_work' => ['Junior developer', 'Middle developer', 'Senior developer'],
        'duration_work'=> ['Jun 2010 - Mar 2012', 'Mar 2012 - Dec 2014', 'Jan 2015'],
        'website_company'=> ['junior.com', 'middle.com']
	];
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work_experience['post_work'][2]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience['duration_work'][2]; ?> - <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p>Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work_experience['post_work'][1]; ?> / <?php echo $work_experience['website_company'][1]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience['duration_work'][1]; ?></h6>
          <p>Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $work_experience['post_work'][0]; ?> / <?php echo $work_experience['website_company'][0]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience['duration_work'][0]; ?></h6>
